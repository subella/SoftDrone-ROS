...
class GoalController(Sofa.PythonScriptController):
    ...
    def onBeginAnimationStep(self, dt):
        ...
        self.beta += math.pi/50
        n = [math.cos(self.beta), 0, math.sin(self.beta)]
        q = n[0]
        
        pos = [self.mo.position[0][0], self.mo.position[0][1], self.mo.position[0][2]]
        
        self.mo.position = [[pos[0], pos[1], pos[2], 
                             n[0]*math.sin(self.alpha/2.0), 
                             n[1]*math.sin(self.alpha/2.0), 
                             n[2]*math.sin(self.alpha/2.0),
                             math.cos(self.alpha/2.0)]]
