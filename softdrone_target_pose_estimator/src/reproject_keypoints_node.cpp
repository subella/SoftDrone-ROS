...
std::string keypoints_2D_topic_;
std::string keypoints_3D_topic_;
std::string rgb_cam_info_topic_;
std::string depth_img_topic_;

void load_params(const ros::NodeHandle& nh)
{
  nh.getParam("reproject_keypoints_params/keypoints_2D_topic", keypoints_2D_topic_);
  nh.getParam("reproject_keypoints_params/keypoints_3D_topic", keypoints_3D_topic_);
  nh.getParam("reproject_keypoints_params/rgb_cam_info_topic", rgb_cam_info_topic_);
  nh.getParam("reproject_keypoints_params/depth_img_topic",    depth_img_topic_);
}
